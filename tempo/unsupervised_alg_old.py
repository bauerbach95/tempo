...
from . import generate_null_dist_old
...
def run(adata,
	...
	**kwargs):
	...
	# ** run **
	# null_log_evidence_vec = generate_null_dist_old.generate(adata = clock_adata, null_head_folder_out=evidence_folder_out,learning_rate_dict=vi_gene_param_lr_dict,
	...
	null_log_evidence_vec = np.array([-100000000])
